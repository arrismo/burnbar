...
Burnbar is based on [CodexBar](https://github.com/steipete/CodexBar), MIT licensed. The original CodexBar README continues below while the Burnbar product/UI is being carved out.
